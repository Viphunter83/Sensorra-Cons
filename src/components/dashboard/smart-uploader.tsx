...
export function SmartUploader({ propertyId, projectId, defaultDocType, metadata }: { propertyId: string, projectId?: string, defaultDocType?: string, metadata?: Record<string, unknown> }) {
